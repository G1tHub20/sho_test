...
// DBに受験履歴を反映
$dbh = dbconnect();
$stmt = $dbh->prepare('INSERT INTO history (score, test_id, user_id) VALUES (:score, :test_id, :user_id);');
...
// テストの情報を反映
// 平均点の取得
$stmt1 = $dbh->prepare('SELECT AVG(score) as avg_score FROM history WHERE test_id=:test_id;');
